	    ...
	    /** @private */
 	    ...
 	    /** @private */
   		...
   		private function mouseOver(event: MouseEvent): void {
  			var node: GraphNode = _dataProvider.findNode(UIComponent(event.currentTarget));
   			if(node != null)
   				if(Object(node.view).hasOwnProperty("mouseOver"))
   					Object(node.view).mouseOver(event);
   		}

   		private function mouseOut(event: MouseEvent): void {
  			var node: GraphNode = _dataProvider.findNode(UIComponent(event.currentTarget));
   			if(node != null)
   				if(Object(node.view).hasOwnProperty("mouseOut"))
   					Object(node.view).mouseOut(event);
   		}
